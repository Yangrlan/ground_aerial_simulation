...
void LivoxPointsPlugin::OnNewLaserScans() {
    if (rayShape) {
        ...
        scan_point.fields[3].name = "intensity";
        scan_point.fields[3].offset = 12;  
        scan_point.fields[3].datatype = sensor_msgs::PointField::UINT8;
        scan_point.fields[3].count = 1;

        scan_point.fields[4].name = "time";
        scan_point.fields[4].offset = 13;  // 前 13 字节（x+y+z+intensity）
        scan_point.fields[4].datatype = sensor_msgs::PointField::FLOAT32;
        scan_point.fields[4].count = 1;
        // 4 * 3 + 1 + 4 = 17
        scan_point.point_step = 17;

        scan_point.width = points_pair.size();  // 点数量
        scan_point.height = 1;
        scan_point.data.resize(scan_point.width * scan_point.point_step);
